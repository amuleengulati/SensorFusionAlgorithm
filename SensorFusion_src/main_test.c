...
int main(int argc, char ** argv){
    ...
    * This fuction performs (e^-(abolute(reading[i]-reading[j]))) for 2 sensors 
    ...
    */
    ...
    support_degree_test = support_degree_matrix(sdm_test,num1);
