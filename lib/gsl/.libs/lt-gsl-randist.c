...
/* ./.libs/lt-gsl-randist.c - temporary wrapper executable for .libs/gsl-randist
...
const char * TARGET_PROGRAM_NAME = "gsl-randist"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# gsl-randist - temporary wrapper script for .libs/gsl-randist\n", f);
  ...
  fputs ("    echo \"gsl-randist:gsl-randist:${LINENO}: libtool wrapper (GNU libtool) 2.4.", f);
  fputs ("2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"gsl-randist:gsl-randist:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg", f);
  fputs ("\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"gsl-randist:gsl-randist:${LINENO}: newargv[0]: $progdir/$program", f);
  fputs ("\" 1>&2\n", f);
