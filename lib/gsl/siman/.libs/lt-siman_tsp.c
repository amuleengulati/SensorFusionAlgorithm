...
/* ./.libs/lt-siman_tsp.c - temporary wrapper executable for .libs/siman_tsp
...
const char * TARGET_PROGRAM_NAME = "siman_tsp"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# siman_tsp - temporary wrapper script for .libs/siman_tsp\n", f);
  ...
  fputs ("    echo \"siman_tsp:siman_tsp:${LINENO}: libtool wrapper (GNU libtool) 2.4.2\" 1", f);
  fputs (">&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"siman_tsp:siman_tsp:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"siman_tsp:siman_tsp:${LINENO}: newargv[0]: $progdir/$program\" 1>", f);
  fputs ("&2\n", f);
