...
/* ./.libs/lt-gsl-histogram.c - temporary wrapper executable for .libs/gsl-histogram
...
const char * LIB_PATH_VALUE   = "/cygdrive/c/Users/sony/Downloads/gsl-latest/gsl-2.6/.libs:/cygdrive/c/Users/sony/Downloads/gsl-latest/gsl-2.6/cblas/.libs:";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/cygdrive/c/Users/sony/Downloads/gsl-latest/gsl-2.6/.libs:/cygdrive/c/Users/sony/Downloads/gsl-latest/gsl-2.6/cblas/.libs:/usr/local/lib:/usr/local/bin:";
const char * TARGET_PROGRAM_NAME = "gsl-histogram"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# gsl-histogram - temporary wrapper script for .libs/gsl-histogram\n", f);
  ...
  fputs ("  notinst_deplibs=' libgsl.la /cygdrive/c/Users/sony/Downloads/gsl-latest/gsl-2", f);
  fputs (".6/cblas/libgslcblas.la cblas/libgslcblas.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"gsl-histogram:gsl-histogram:${LINENO}: libtool wrapper (GNU libtool) ", f);
  fputs ("2.4.2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"gsl-histogram:gsl-histogram:${LINENO}: newargv[$lt_dump_args_N]: $lt", f);
  fputs ("_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"gsl-histogram:gsl-histogram:${LINENO}: newargv[0]: $progdir/$pro", f);
  fputs ("gram\" 1>&2\n", f);
  ...
  fputs ("    PATH=/cygdrive/c/Users/sony/Downloads/gsl-latest/gsl-2.6/.libs:/cygdrive/c/", f);
  fputs ("Users/sony/Downloads/gsl-latest/gsl-2.6/cblas/.libs:/usr/local/lib:/usr/local/b", f);
  fputs ("in:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/cygdrive/c/Users/sony/Downloads/gsl-latest/gsl-2.6/.libs:/cygdrive/c", f);
  fputs ("/Users/sony/Downloads/gsl-latest/gsl-2.6/cblas/.libs:$PATH\"\n", f);
  fputs ("\n", f);
